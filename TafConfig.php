...
class TafConfig
{
    ...
    public $database_name = "gestion_dahira"; // nom de la base de données
    ...
    public $documentation_username = "admin_ges_dahira"; // nom d'utilisateur pour accéder à la documentation
